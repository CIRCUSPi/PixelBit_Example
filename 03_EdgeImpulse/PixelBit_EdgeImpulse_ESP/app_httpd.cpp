...
*/
#include <PixelBit_mora_inferencing.h>
...
void startCameraServer()
{
    ...
    httpd_uri_t capture_uri = {.uri      = "/capture",     // v12345vtm
                               .method   = HTTP_GET,
                               .handler  = capture_handler,
                               .user_ctx = NULL};

    httpd_uri_t inference_uri = {.uri = "/inference", .method = HTTP_GET, .handler = inference_handler, .user_ctx = NULL};

    httpd_uri_t inference_results_uri = {.uri = "/inference-results", .method = HTTP_GET, .handler = inference_results_handler, .user_ctx = NULL};
