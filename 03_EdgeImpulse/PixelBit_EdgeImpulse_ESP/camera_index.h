...
<head>
    ...
    <title>Edge Impulse on PixelBit</title>
    <style>
        body {
...
<body>
    <section class="main">
        <div id="logo">
            <div class="center">
                <img src="https://www.circuspi.com/wp-content/uploads/2022/04/CIRCUS-Pi.png"
                    alt="logo" width="160" height="150" />
                <h1 class="bold">Edge Impulse on PixelBit</h2>
            </div>
        </div>
        <div id="content">
            <div id="sidebar">
            ...
            function () {
                ...
                function httpReq(endpoint) {
                    fetch(`${window.location.href}` + endpoint)
                        // fetch(`http://192.168.1.67/` + endpoint)
